...
//            oauthRedirectURL = "https://www.facebook.com/connect/login_success.html";
    ...
    function oauthCallback(url) {
        ...
        if (url.indexOf("access_token=") > 0) {
            ...
            tokenStore['gltoken'] = obj['access_token'];
            if (loginCallback)
    ...
    function logout(callback) {
        var logoutWindow,
                token = tokenStore['gltoken'];

        var logoutStatus = {};
        if (token) {
            tokenStore.removeItem('gltoken');
    ...
    function api(obj) {
        ...
        params['access_token'] = tokenStore['gltoken'];
